...
namespace ProyectoVideoJuegos.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(ProyectoVideoJuegosDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdUsuario,Nombre,Apellido,Username,Contraseña")] Usuario usuario)
        {
